...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            ...
            <div class="mt-3">
                <Link href="/municipios/create" :class="buttonVariants({ variant: 'outline' })">Agregar Municipio
                </Link>
            </div>
                ...
                <TableBody>
                    <TableRow v-for="municipio in municipios" :key="municipio.id">
                        ...
                        <TableCell class="space-x-2">
                            <Link :href="`/municipios/${municipio.id}`" :class="buttonVariants({ variant: 'secondary' })
                                ">Show</Link>

                            <Link :href="`/municipios/${municipio.id}/edit`" :class="buttonVariants({ variant: 'default' })
                                ">Edit</Link>
