...
<template>
    ...
    <header
        class="sticky top-0 z-50 w-full border-b border-rose-100 bg-white/80 backdrop-blur-md dark:border-zinc-800 dark:bg-black/80">
                ...
                <template v-if="$page.props.auth.user">
                    ...
                    <Link :href="logout()" method="post" as="button">
                        <Button variant="outline" size="sm"
                            class="border-rose-200 text-rose-600 hover:bg-rose-50">Cerrar Sesión</Button>
                    </Link>
                </template>
                <template v-else>
    ...
    <main class="bg-white dark:bg-zinc-950">
        ...
        <section class="relative overflow-hidden px-6 pt-10 pb-10 text-center md:pt-10 md:pb-10">
            <div
                class="absolute top-0 left-1/2 -z-10 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-rose-50/50 blur-3xl dark:bg-rose-900/10">
            </div>

            <div class="mx-auto max-w-4xl">
                <Badge variant="outline"
                    class="mb-4 border-rose-200 bg-rose-50 text-rose-600 dark:bg-rose-950 dark:text-rose-400">
                    ❤ Salvando vidas hoy
                </Badge>
                <h1
                    class="animate-fadeIn mb-6 text-5xl font-black tracking-tight text-slate-900 md:text-7xl dark:text-white leading-[1.1]">
                    Conectamos esperanza <br />
                    <span class="bg-gradient-to-r from-rose-500 to-orange-500 bg-clip-text text-transparent">con
                        solidaridad.</span>
                </h1>
                <p
                    class="animate-fadeIn mb-10 text-lg text-slate-600 delay-150 md:text-xl dark:text-slate-400 max-w-2xl mx-auto">
                    La plataforma más rápida para encontrar donadores de sangre y publicar solicitudes urgentes en
                    México.
                </p>
                <div class="animate-fadeIn flex flex-col justify-center gap-4 delay-300 sm:flex-row">
                    <Link href="/register">
                        <Button size="xl"
                            class="h-14 w-full px-8 text-lg bg-rose-500 hover:bg-rose-600 shadow-lg shadow-rose-200 dark:shadow-none sm:w-auto">
                            Necesito Donadores
        ...
        <section class="py-2 px-6 overflow-hidden relative">
            ...
            <div class="mx-auto max-w-6xl">
                <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
                    ...
                    <div
                        class="group p-8 rounded-3xl border border-slate-100 bg-white shadow-sm transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/50">
                        <div
                            class="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-rose-500 text-white shadow-lg shadow-rose-200 dark:shadow-none">
                            <BirdIcon class="h-7 w-7" />
                        </div>
                        ...
                        <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                            Transformar la angustia de buscar donadores en una experiencia de **conexión rápida y
                            efectiva**.
                            Nacimos para que ninguna familia en México tenga que enfrentar sola la urgencia de conseguir
                            sangre,
                    ...
                    <div
                        class="group p-8 rounded-3xl border border-slate-100 bg-white shadow-sm transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/50">
                        <div
                            class="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-500 text-white shadow-lg shadow-blue-200 dark:shadow-none">
                            <Eye class="h-7 w-7" />
                        </div>
                        <h2 class="mb-4 text-3xl font-bold text-slate-900 dark:text-white">Nuestra Visión</h2>
                        <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                            Convertirnos en la **red de apoyo vital más grande del país**, donde la donación de sangre
                            no
                            sea
                            un reto logístico, sino un acto natural y digitalizado. Aspiramos a reducir el tiempo de
                            respuesta
            ...
            <div class="mx-auto max-w-6xl">
                ...
                <div class="grid gap-12 md:grid-cols-3">
                    <div class="relative text-center">
                        <div
                            class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-rose-100 text-rose-600 dark:bg-rose-900/30">
                            <UserPlus class="h-8 w-8" />
                        </div>
                        <h3 class="mb-3 text-xl font-bold">1. Crea tu cuenta</h3>
                        <p class="text-slate-600 dark:text-slate-400">Regístrate en menos de un minuto para tener acceso
                            a
                            la red de donadores.</p>
                    </div>

                    <div class="relative text-center">
                        <div
                            class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-100 text-blue-600 dark:bg-blue-900/30">
                            <Zap class="h-8 w-8" />
                        </div>
                        <h3 class="mb-3 text-xl font-bold">2. Publica tu solicitud</h3>
                        <p class="text-slate-600 dark:text-slate-400">Indica tipo de sangre, hospital y ubicación. Es
                            rápido
                            y sencillo.</p>
                    </div>
                    ...
                    <div class="relative text-center">
                        <div
                            class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-green-100 text-green-600 dark:bg-green-900/30">
                            <ShieldCheck class="h-8 w-8" />
                        </div>
                        <h3 class="mb-3 text-xl font-bold">3. Recibe ayuda</h3>
                        <p class="text-slate-600 dark:text-slate-400">Tu anuncio llegará a las personas indicadas para
                            coordinar la donación.</p>
                    </div>
                </div>
            </div>
        </section>

        <section class="py-15 px-6 bg-slate-50 dark:bg-zinc-900/50">
            <div class="mx-auto max-w-6xl">
                <div class="mb-16 text-center">
                    <h2 class="text-3xl font-bold md:text-4xl text-slate-900 dark:text-white">Aumenta la visibilidad de
                        tu
                        anuncio
                    </h2>
                ...
                <div class="grid gap-8 lg:grid-cols-3">
                    ...
                    <Card
                        class="relative border-2 border-rose-500 shadow-xl transition-transform hover:scale-[1.02] dark:bg-zinc-900">

                        <div
                            class="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-rose-500 px-4 py-1 text-xs font-bold text-white uppercase">
                            Recomendado</div>
                        <CardHeader>
                            ...
                            <div class="mt-4 text-4xl font-black text-white">$179<span
                                    class="text-sm font-normal text-zinc-500">/anuncio</span></div>
                        </CardHeader>
                        <CardContent class="space-y-4 text-zinc-300">
                            ...
                            <div class="flex items-center gap-2 text-sm">
                                <Pin class="h-4 w-4 text-yellow-400 fill-current" /> Anclado al inicio del listado
                            </div>
                            <div class="flex items-center gap-2 text-sm">
                                <Clock class="h-4 w-4 text-yellow-400" /> 15 días de vigencia
                            </div>
                            <div class="flex items-center gap-2 text-sm">
                                <MessageCircle class="h-4 w-4 text-yellow-400" /> Maxima difusión en diferentes canales
                            </div>
                        </CardContent>
                        <CardFooter>
                    ...
                    <Card
                        class="border-none shadow-md transition-transform hover:scale-[1.02] dark:bg-zinc-900 bg-zinc-900 text-white dark:ring-1 dark:ring-zinc-800">


                        <CardHeader>
                            <CardTitle class="text-xl">Prioritario</CardTitle>
                            <CardDescription>Mayor alcance y tiempo</CardDescription>
                            <div class="mt-4 text-4xl font-black">$159<span
                                    class="text-sm font-normal text-slate-400">/anuncio</span></div>
                        </CardHeader>
                        <CardContent class="space-y-4">
                            <div class="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                                <CheckCircle2 class="h-4 w-4 text-rose-500" /> Destacado en búsquedas - segunda
                                prioridad
                            </div>
                            <div class="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                            ...
                            <div class="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                                <CheckCircle2 class="h-4 w-4 text-rose-500" /> Mayor difusión en canales
                            </div>
                        </CardContent>
                        <CardFooter>

                            <Button variant="secondary" class="w-full bg-white text-black hover:bg-zinc-200">Elegir Muy
                                Prioritario</Button>
                        </CardFooter>
                    </Card>
                </div>
