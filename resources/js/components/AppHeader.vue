...
<template>
    ...
    <div v-if="user">
        ...
        >-->
        <div class="border-b border-sidebar-border/80 bg-[#b91c1c] text-dark">
                        ...
                        <SheetContent side="left" class="w-[300px] p-6">
                            ...
                            <div class="flex h-full flex-1 flex-col justify-between space-y-4 py-6">
                                <nav class="-mx-3 space-y-1">
                                    <Link v-for="item in filteredNavItems" :key="item.title" :href="item.href"
                ...
                <div class="hidden h-full lg:flex lg:flex-1">
                    <NavigationMenu class="ml-10 flex h-full items-stretch">
                        <NavigationMenuList class="flex h-full items-stretch space-x-2">
                            <NavigationMenuItem v-for="(item, index) in filteredNavItems" :key="index"
    ...
    <div v-else class="border-b border-sidebar-border/80 bg-[#b91c1c] text-white">
        <div class="mx-auto flex h-18 max-w-7xl items-center justify-between px-6">
            <!-- IZQUIERDA -->
            <Link href="/solicitantes" class="text-lg font-bold">
                DonadorRapido.mx
            </Link>
